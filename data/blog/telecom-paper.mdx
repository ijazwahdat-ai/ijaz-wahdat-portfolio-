...
*   Specific USSD activation codes for Afghan Telecom Companies.
...
### Human Evaluation
Ten telecom experts from MCIT evaluated the model's responses on real-world queries:

*   **Factual Correctness:** **89.0%**
*   **Fluency:** **93.0%**
*   **Relevance:** **89.0%**

> "The model consistently retrieves and presents exact, domain-specific information, such as the correct USSD code (*789#) for balance checks."
